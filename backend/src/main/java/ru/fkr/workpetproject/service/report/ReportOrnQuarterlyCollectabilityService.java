package ru.fkr.workpetproject.service.report;
...
import ru.fkr.workpetproject.repository.ReportOrnQuarterlyCollectabilityRepository;
...
@Service
@EnableAsync
public class ReportOrnQuarterlyCollectabilityService {

    @Autowired
    private ReportOrnQuarterlyCollectabilityRepository reportOrnQuarterlyCollectabilityRepository;
    private long lastDurationMillis = -1;

    public List<Object[]> getQuarterlyProcuracyCollectability(LocalDate date) {
        return reportOrnQuarterlyCollectabilityRepository.getQuarterlyProcuracyCollectability(date);
    }

    public List<Object[]> getQuarterlyProcuracyDebt(LocalDate date) {
        return reportOrnQuarterlyCollectabilityRepository.getQuarterlyProcuracyDebt(date);
    }

    public List<LocalDate> getAvailableReportDates() {
        return reportOrnQuarterlyCollectabilityRepository.getAvailableReportDates();
    }

    public Map<String, Object> checkFillAvailability() {
        return reportOrnQuarterlyCollectabilityRepository.checkFillAvailability();
    }

    public Map<String, Object> checkProgressStatusReportOrnQuarterlyCollectability() {
        return reportOrnQuarterlyCollectabilityRepository.checkProgressStatusReportOrnQuarterlyCollectability();
    }
    ...
    public CompletableFuture<Map<String, Object>> fillReport() {
        ...
        try {
            Map<String, Object> result = reportOrnQuarterlyCollectabilityRepository.fillReport();
            ...
            for (Object[] rowDataCollectability : dataCollectability) {
                ...
                for (int i = 2; i < rowDataCollectability.length; i++) {
                    ...
                    if (rowDataCollectability[i] instanceof Number) {
                        ...
                        cell.setCellValue(rowDataCollectability[i].toString());
                    }
                }
